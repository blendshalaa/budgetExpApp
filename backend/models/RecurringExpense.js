...
const RecurringExpense={
    ...
    updateRecurring:async({category_id,amount,frequency,start_date,end_date})=>{
        const result=await pool.query("UPDATE recurring_expenses SET category_id=$1 , amount=$2,frequency=$3,start_date=$4,end_date=$5 RETURNING *",
            [category_id,amount,frequency,start_date,end_date]
        );
        return result.rows[0];
